...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : BDC_SNSOUT_Pin BDC_FLT_Pin */
  GPIO_InitStruct.Pin = BDC_SNSOUT_Pin|BDC_FLT_Pin;
  ...
  /*Configure GPIO pin : BDC_SLEEP_Pin */
  GPIO_InitStruct.Pin = BDC_SLEEP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(BDC_SLEEP_GPIO_Port, &GPIO_InitStruct);
